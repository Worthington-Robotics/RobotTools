...
from launch.actions import IncludeLaunchDescription, DeclareLaunchArgument, SetEnvironmentVariable, LogInfo, OpaqueFunction
...
def generate_launch_description():
    ...
    rtab_launch = LaunchDescription([
        ...
        DeclareLaunchArgument('rgb_topic',           default_value='/zed2/zed_node/rgb/image_rect_color',       description=''),
        DeclareLaunchArgument('depth_topic',         default_value='/zed2/zed_node/depth/depth_registered', description=''),
        DeclareLaunchArgument('camera_info_topic',   default_value='/zed2/zed_node/rgb/camera_info',            description=''),
        ...
        # imu
        DeclareLaunchArgument('imu_topic',        default_value='/zed2/zed_node/imu/data', description='Used with VIO approaches and for SLAM graph optimization (gravity constraints).'),
